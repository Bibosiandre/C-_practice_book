...
{
  // запрос для получения всех категорий и связанных с ними продуктов
...
// мы хотим легко показать разницу между выводом
// XML использует элементы или атрибуты, поэтому мы определим 
// делегат для ссылки на два разных метода.
